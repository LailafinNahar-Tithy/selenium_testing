...
public class Affiliate_Account {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Form Fill up for Affiliate Membership ( Cheque Payment Method)
		...
		driver.findElement(By.xpath("//*[@id=\"input-payment-cheque\"]")).click(); // Cheque Select
		driver.findElement(By.xpath("//*[@id=\"input-cheque\"]")).sendKeys("Lailafin Nahar Tithy"); // Cheque Payee Name Input
